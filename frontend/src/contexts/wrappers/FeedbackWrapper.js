...
export function FeedbackWrapper({ children }) {
    const [ feedback, dispatchFeedback ] = useReducer(feedbackReducer, { open: false, backgroundColor: "", message: "" })
    ...
    return (
            <FeedbackProvider value={{ feedback, dispatchFeedback}}>
                ...
                ContentProps={{
                    style: {backgroundColor: feedback.backgroundColor, fontSize: '1.25rem'}
                }} 
